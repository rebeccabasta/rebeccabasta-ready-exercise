...
The dataset includes height, weight, and gender. I added preffered study time and weekly exercise time to extend the data. Preffered study time is a catergorical variable (morning, afternoon, night). Weekly exercise time is a numerical value representing the amount of time in minutes that an individual exercises per week. A description of all the variables is provided in the codebook. 
