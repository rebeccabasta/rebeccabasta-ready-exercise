...
mydata$Studytime <- mydata$Weight^2
mydata$Exercisetime <- mydata$Weight * as.numeric(mydata$Gender)

#### Third model fit
# fit linear model using height as outcome, study time and exercise time as predictor

lmfit3 <- lm(Height ~ Exercisetime + Studytime, mydata)  
